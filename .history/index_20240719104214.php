...
<div class="ms-3">
    ...
    <p class="text-white">React et Vue.js</p> <img src="images/robot.png" alt="robot" loading="lazy" class="imgcard img-fluid"> <img src="images/card2.png" alt="site internet" loading="lazy" class="img-fluid">
