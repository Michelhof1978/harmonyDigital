...
<div class="d-md-none">
    ...
    <div class="text-center" style="margin-bottom: 0;">
        <h2 class="border borderColor border-4 rounded p-2 m-0">
            <strong class="text-white">Robots Dévoués</strong>
        </h2>
        <p class="text-white lead fs-2 ms-2 me-2 fw-bold mb-0 mt-2">
            La Satisfaction Client en Priorité
        </p>
    </div>

    <div class="container d-flex justify-content-center align-items-center" style="min-height: calc(100vh - 4rem); padding: 0;">
        <!-- Vidéo pour les écrans de taille petite à moyenne -->
        <div class="w-100">
            <video autoplay loop muted playsinline class="w-100 rounded" style="display: block; margin: 0;">
                <source src="videos/robotordi.mp4" type="video/mp4">
                Votre navigateur ne supporte pas la balise <code>video</code>.
            </video>
        </div>
