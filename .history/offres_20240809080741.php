...
<div class="d-block d-md-none">
    ...
    <section class="container mb-4">
        <div class="row">
            <div class="col-12 text-center">
                <img src="images/robotinfo1.png" alt="robot" loading="lazy" class="img-fluid w-75 mt-3">
            </div>
        </div>
        <div class="row">
            <div class="col-12">
    ...
    <section class="container mb-4">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <img src="images/robotinfo2.png" alt="robot" loading="lazy" class="img-fluid w-75 mt-3">
            </div>
        </div>
    </section>
    ...
    <section class="container mb-4">
        <div class="row">
            <div class="col-12 text-center">
                <img src="images/robotinfo3.png" alt="robot" loading="lazy" class="img-fluid w-75 mt-3">
            </div>
        </div>
        <div class="row">
            <div class="col-12">
    ...
    <section class="container mb-4">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <img src="images/robotinfo4.png" alt="robot" loading="lazy" class="img-fluid w-75 mt-3">
            </div>
        </div>
    </section>

    <div class="text-center mb-4">
        <img src="images/robotinfo5.png" alt="robot" loading="lazy" class="img-fluid w- mt-3">
    </div>
</div>
<!-- FIN OFFRES MOBILE -->
