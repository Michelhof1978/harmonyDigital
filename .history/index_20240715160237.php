...
<body>
    ...
    <script>
        ...
        function generateBinaryBackground() {
            ...
            const binaryChars = [];
            const charsPerLine = Math.floor(window.innerWidth / 15); // Ajuster le nombre de caractères par ligne
            ...
            function createLine() {
                ...
                setTimeout(createLine, 250); // Ajuster la vitesse d'apparition des lignes
            }
