        ...
        <div class="col-12 col-md-6 mt-4 text-white order-3 order-md-2">
            <div class="d-flex justify-content-center">
                <p class="fs-5 lead p-3 intro mx-auto fw-bold">
                    Nous pouvons réaliser tous vos projets à distance en effectuant des points réguliers via le réseau <a href="https://discord.com" class="text-decoration-underline text-primary" target="_blank" rel="noopener noreferrer"><span class="text-orange-nav fs-4">Discord</span></a> .
                </p>
            </div>
