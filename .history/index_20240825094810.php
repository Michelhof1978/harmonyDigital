...
<div class="container-fluid px-0 mb-5 d-none d-md-block">
    <div class="d-flex justify-content-between align-items-center" style="min-height: 50vh;">
        ...
        <!-- Image Section -->
        <div class="image-container" style="max-width: 50%; flex: 1; padding: 20px;">
            <a href="https://www.example.com" target="_blank" rel="noopener noreferrer">
                <img src="images/caravanesdelabesbre.webp" alt="Description de l'image" class="w-50 img-fluid" style="width: 100%; height: auto; display: block;">
            </a>
        </div>
    </div>
</div>
