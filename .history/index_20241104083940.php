...
<div class="d-none d-md-flex ms-5 mb-5 position-relative justify-content-center">
    <div class="w-50 textIntro neon-section">
        ...
        <p class="text-white lead">
            <strong>Logos, <a href="https://www.hubspot.fr/products/cms/website-themes-templates/what-is#:~:text=D%C3%A9finition%20d'un%20template%20de,site%2C%20m%C3%AAme%20sans%20comp%C3%A9tences%20graphiques." target="_blank" class="link-white">templates</a> Web, plaquette publicitaire, cartes de visite, newsletters...</strong>
        </p>
    </div>
