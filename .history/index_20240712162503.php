...
.carousel-inner {
  padding-left: 50px; /* Ajustez cette valeur en fonction de la largeur de votre bouton */
  padding-right: 50px; /* Ajustez cette valeur en fonction de la largeur de votre bouton */
}
