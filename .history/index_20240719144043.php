...
<body>
    ...
    <div>
            <h2 class="border borderColor border-4 rounded p-2  m-5 text-center">
     ...
     <!-- PRESENTATION -->
     <section class="d-flex ms-5 mb-5 position-relative justify-content-center border rounded">
