...
<body>
    ...
    <div class="col-sm-12 col-xl-6 ">
        <p class="textIntro lead bg-light rounded shadow p-4 pb-5 bg-white rounded ms-1 me-1 ">
          Profitez d'une expérience de camping unique au  target="_blank">Camping proche du Pal de Dompierre Sur Besbre</a>, situé à proximité du parc d'attractions <a href="<?php echo PAL_URL; ?>" target="_blank">Le-Pal</a></strong>.
