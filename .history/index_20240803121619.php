                ...
                <div class="carousel-item active">
                    <div class="d-flex justify-content-center">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="votre-url-1" class="info btn text-white mb-5">Plus d'infos !</a>
                            </div>
                        </div>
                        <div class="card">
                            <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                        ...
                        <div class="card">
                            ...
                            <strong class="pricecard text-white custom-animation mb-5 fs-1 ">À partir de 125,00 €</strong>
                            <div class="card-body">
