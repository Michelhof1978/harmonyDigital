...
<!-- ROBOT VIDEO MOBILE -->
<div class="d-md-none" style="margin: 0 !important; padding: 0 !important; height: 100vh; display: flex; flex-direction: column; justify-content: center;">
    <!-- Contenu à afficher uniquement sur les écrans plus petits que moyens -->
    <div class="text-center" style="margin: 0 !important; padding: 0 !important; flex-shrink: 0;">
        <h2 class="border borderColor border-4 rounded p-2" style="margin: 0 !important;">
            <strong class="text-white">Robots Dévoués</strong>
        </h2>
        <p class="text-white lead fs-2 ms-2 me-2 fw-bold" style="margin: 0 !important; padding: 0 !important;">
            La Satisfaction Client en Priorité
        </p>
    </div>

    <div class="container d-flex justify-content-center align-items-center" style="flex: 1; margin: 0 !important; padding: 0 !important;">
        <!-- Vidéo pour les écrans de taille petite à moyenne -->
        <div class="w-100" style="margin: 0 !important; padding: 0 !important;">
            <video autoplay loop muted playsinline class="w-100 rounded" style="display: block; margin: 0 !important; padding: 0 !important;">
                <source src="videos/robotordi.mp4" type="video/mp4">
                Votre navigateur ne supporte pas la balise <code>video</code>.
            </video>
        </div>
