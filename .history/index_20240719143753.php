...
<body>
    ...
    <div>
            <h2 class="border borderColor border-4 rounded p-2  m-5">
                <strong class="text-white"><span class="text-orange-titre">D</span>omaine<span class="text-orange-titre"> D</span>e</strong><span class="text-orange-titre">D</span>omaine<span class="text-orange-titre"> C</span>o</strong>
            </h2>
        </div>
