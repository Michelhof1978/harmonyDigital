...
<!-- FIN ROBOT VIDEO MOBILE -->
    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            ...
            <div class="col-8">
                <p class="lead text-white text-center fw-bold fs-5 mt-5">
                De <span cl>l’idée à sa réalisation</span>, Harmony Digital s’appuie sur ses valeurs de transparence, de bienveillance et d’innovation pour accompagner ses clients d’un bout à l’autre de leur démarche de transformation digitale : penser et designer la solution, la développer, la maintenir et la faire évoluer.<br><br>
