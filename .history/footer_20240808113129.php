        ...
        <div class="container">
            <div class="row">
                <div class="text-center">
                    ...
                    <p>Copyright &copy; <span id="date"></span>, Droits réservés <a href="https://cvmichel-hoffmann.fr/" target="_blank"><br><span class="mt-">Hoffmann Michel-Harmony Digital</span></a></p>
                    </div>
                </div>
            </div>
        </div>
