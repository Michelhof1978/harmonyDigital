    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand ms-2" href="index.php">
            <strong class="text-white nav-brand">
                <img src="path/to/your/image-h.png" alt="H" class="logo-img">armony 
                <img src="path/to/your/image-d.png" alt="D" class="logo-img">igital
            </strong>
            <img src="path/to/your/image-dot.png" alt="." class="logo-dot">
        </a>
    </div>
</div>
