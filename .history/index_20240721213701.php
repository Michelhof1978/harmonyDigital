...
<section class="text-center mt-4 m-2">
    ...
    <div class=" g-0 flex-column flex-md-row">
        ...
        <div class="">
            <h2 class="text-white neon-yellow   "><strong>Réalisations Campagnes Clients</strong></h2>
            <img src="images/robotVideo" alt="image robot" loading="lazy" class="robotVideo img-fluid w-50 "></a>
        </div>
