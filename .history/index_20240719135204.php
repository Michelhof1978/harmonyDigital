    ...
    <div class="w-75 textIntro">
        <div class="">
            <div class="mb-4">
                ...
                <p class="text-white lead"><strong>Site vitrine, corporate, évènementiel, e-commmerce adaptable mobile et tablette</p>
            </div>
            
            <div class="ms-3">
                <img src="images/intro2.png" alt="site internet" loading="lazy" class="img-fluid">
                <p class="text-white lead"><strong>Logos, templates Web, plaquettes publicitaires, cartes de visite, newsletters...</p>
            </div>

            <div class="ms-3">
                <img src="images/intro3.png" alt="site internet" loading="lazy" class="img-fluid">
                <p class="text-white lead"><strong>PHP et MYSQL</p>
            </div>

            <div class="ms-3">
                <img src="images/intro4.png" alt="site internet" loading="lazy" class="img-fluid">
                <p class="text-white lead"><strong>Codage à la main respectueux des standards du web</p>
            </div>

            <div class="ms-3">
                <img src="images/intro5.png" alt="site internet" loading="lazy" class="img-fluid">
                <p class="text-white lead"><strong>React et Vue.js</p>
            </div>

            <div class="ms-3">
                <img src="images/intro6.png" alt="site internet" loading="lazy" class="img-fluid">
                <p class="text-white lead"><strong>Accessibilité & ergonomie des pages web</p>
            </div>
