                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                        <div class="copyright-text">
                            <p>Copyright &copy; 2024, Droits réservés <a href="https://codepen.io/anupkumar92/">Anup</a></p>
                        </div>

                        <p class="color-weight" style="color: white;">© <span id="date"></span>
        <a class="text-dark" href="" target="_blank">Harmony Digital-Droits réservés</a>
    </p>
                    </div>
