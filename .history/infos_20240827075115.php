...
<div class="d-none d-md-block">
    ...
    <div class="container">
        <p class="lead text-white text-center fs-5 mt-5 mb-5 fw-bold">
            ...
            <a href="https://www.example.com"UX<a> (User Experience) et <span style="color: #e06717e4 ;">CX</span> (Customer Experience) sont au cœur de notre politique d’Innovation !
        </p>
</div>
