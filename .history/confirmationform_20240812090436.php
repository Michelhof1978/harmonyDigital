...
<?php if (isset($_SESSION['message_sent']) && $_SESSION['message_sent'] === true): ?>
    <section class="confirmation mb-5">
        <h4 class="m-5 text-center border border-3  text-white p-2 display-6 h4Index" id="contact"><strong>MESSAGE ENVOYE</strong></h4>
        <div class="text-center">
            <div class=" fw-bold lead  display-4 text-success  text-center p-4 pb-5 ms-1 me-1 mb-5">
                <p>
...
<?php else: ?>
    ...
    <section class="confirmation mb-5">
        ...
        <div class="text-center">
            <div class="lead text- fw-bold  display-4 text-center p-4 pb-5 ms-1 me-1 mb-5">
                <p>
