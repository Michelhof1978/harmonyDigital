...
@media (max-width: 767.98px) { /* Ajustez selon vos besoins */
    .carousel-item {
        padding: 0 15px; /* Assurez-vous que les cartes ne touchent pas les bords */
    }
...
<!-- FIN INTRO-->
    ...
    <div id="tarifCarousel" class="carousel slide carousel-container">
        <div class="carousel-inner">
            ...
            <!-- Vous pouvez ajouter d'autres items ici de la même manière -->
        </div>
