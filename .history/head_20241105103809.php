...
<head>
  ...
  <meta name="author" content="HOFFMANN MICHEL - Harmony Digital">
   ...
   <!-- seoBalises Open Graph pour un meilleur partage sur les réseaux sociaux -->
   <meta property="og:title" content="Agence Création de Sites Internet - HARMONY DIGITAL">
    ...
    <!-- Balises pour les mots-clés  -->
    <meta name="keywords" content="création site internet, agence web, SEO, référencement, développement web">
