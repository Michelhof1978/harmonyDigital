...
<!-- ROBOT VIDEO DESKTOP -->
<div class="container-fluid px-0 mb-5 d-none d-md-block" style="margin-left: 85px">
    <div class="row justify-content-center align-items-center g-5" style="min-height: 50vh;">
        ...
        <!-- Image Section -->
        <div class="col-md-6 d-flex justify-content-center ms-5          <a href="https://lescaravanesdelabesbre.fr/" target="_blank" rel="noopener noreferrer">
