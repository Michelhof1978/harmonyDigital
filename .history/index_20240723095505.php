...
<script>
 // Fonction pour vérifier si le popup a déjà été affiché aujourd'hui
  ...
  if (!isPopupShown()) {
    ...
    closeButton.style.cssText = "position: absolute; top: 10px; right: 80px; cursor: pointer; border: none; background: transparent; color: black; font-size: 24px; padding: 0; margin: 0;";
