    ...
    <div class="row">
        ...
        <div class="img3 col-12 pt-3">
            ...
            <div class="mb-2">
                ...
                <!-- Linkedin -->
                <a class="btn btn-primary btn-floating m-1" style="background-color: #0082ca;" href="<?php echo  ?>" target="_blank" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
        ...
        <div class="text-center mb-5">
            <p class="text-center" style="color: white;">
                <strong>Les Caravanes De La Besbre - <a href="<?php ?>" target="_blank">Camping "Les Bords De Besbre"</a> - 03 290 Dompierre Sur Besbre</strong>
            </p>
            <p>
