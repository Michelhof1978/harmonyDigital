...
<script>
 // Fonction pour vérifier si le popup a déjà été affiché aujourd'hui
  ...
  if (!isPopupShown()) {
    ...
    img.style.maxHeight = '90%'; // Max height 90% of viewport height
    img.style.maxWidth = '90%'; // Max width 90% of viewport width
    ...
    closeButton.style.cssText = "position: absolute; top: 10px; right: 10px; cursor: pointer; border: none; background: transparent; font-size: 16px; color: white;";
