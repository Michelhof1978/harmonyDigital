...
<script>
 // Fonction pour vérifier si le popup a déjà été affiché aujourd'hui
  ...
  if (!isPopupShown()) {
    ...
    closeButton.style.cssText = "position: absolute; top: 0px; right: 0px; cursor: pointer; border: none; background: black; color: white; font-size: 24px; padding: 5px; border-radius: 50%;";
