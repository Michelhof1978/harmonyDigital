                ...
                <div class="d-flex justify-content-center">
                    <div class="card mt-2 card-uniform" style="width: 18rem;">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                            <img src="images/card1.png" loading="lazy" alt="Présentation des service création de site web avec un robot" loading="lazy" onmouseover="zoomIn(this)" onmouseout="zoomOut(this)" class="imgcard img-fluid mt-2">
                        </div>
