...
<body>
    ...
    <div>
            <h1 class="border borderColor border-4 rounded  p-2 col m-2">
                <strong class="text-white"><span class="text-orange-titre">C</span>oncepteur<span class="text-orange-titre"> D</span>ites</strong><span class="text-orange-titre">C</span>oncepteur<span class="text-orange-titre"> S</span>ites</strong>
            </h1>
        </div>
    <!-- TARIFS -->
