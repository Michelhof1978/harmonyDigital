...
<?php if (isset($_SESSION['message_sent']) && $_SESSION['message_sent'] === true): ?>
    <section class="confirmation mb-5">
        ...
        <div class="text-center">
            <div class=" fw-bold lead  display-4 text-light-success  text-center p-4 pb-5 ms-1 me-1 mb-5">
                <p>
...
<?php else: ?>
    ...
    <section class="confirmation mb-5">
        ...
        <div class="text-center">
            <div class="lead text-danger fw-bold  display-5 text-center p-4 pb-5 ms-1 me-1 mb-5">
