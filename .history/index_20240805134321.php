...
@media (max-width: 768px) {
    ...
    /* Créer 6 groupes distincts */
    .carousel-inner .carousel-item:nth-child(2) > .d-flex > .card:nth-child(2),
    .carousel-inner .carousel-item:nth-child(2) > .d-flex > .card:nth-child(3) {
        display: none;
    }
    ...
    /* Répéter pour les cartes 3 à 6 */
    .carousel-inner .carousel-item:nth-child(2) > .d-flex > .card:nth-child(3),
    .carousel-inner .carousel-item:nth-child(2) > .d-flex > .card:nth-child(4),
    .carousel-inner .carousel-item:nth-child(2) > .d-flex > .card:nth-child(5),
    .carousel-inner .carousel-item:nth-child(2) > .d-flex > .card:nth-child(6) {
        display: block;
        margin-top: 100vh; /* Cache les cartes en les poussant hors de l'écran */
    }
