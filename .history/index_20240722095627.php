...
.custom-margin .col-md-6:first-child {
  margin-right: 30px; /* Adjust this value to increase/decrease the space */
}
...
<section class="text-center mt-4 container mb-5">
  ...
  <div class="row justify-content-center g-0 custom-margin">
