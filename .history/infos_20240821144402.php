...
@keyframes move {
    ...
    <img src="images/banniererobotinfos.webp" alt="Bannière de bienvenue avec un robot" class="img-fluid w-50 rounded">
</div>
<!--Fin Banner mobile -->

 <!--Banner desktop -->
<div class="container-fluid d-flex justify-content-center align-items-center full-height mt-5  d-md-none">
    <img src="images/banniererobotinfos.webp" alt="Bannière de bienvenue avec un robot" class="img-fluid w-100 rounded">
</div>
 <!--Fin Banner desktop -->
...
<div class="d-none d-md-block">
    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-4">
                <img src="images/robotinfo1.webp" alt="robot" loading="lazy" class="img-fluid w-50 mt-3">
            </div>
            <div class="col-8">
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-4">
                <img src="images/robotinfo2.webp" alt="robot" loading="lazy" class="img-fluid w-50 mt-3">
            </div>
        </div>
</div>
...
<!-- FIN ROBOT VIDEO MOBILE -->
    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="col-4">
                <img src="images/robotinfo3.webp" alt="robot" loading="lazy" class="img-fluid w-50 mt-3">
            </div>
            <div class="col-8">
                <p class="lead text-white text-center fw-bold fs-5 mt-5">
    ...
    <div class="container mt-4 mb-5">
        <div class="row">
            ...
            <div class="col-4">
                <img src="images/robotinfo4.webp" alt="robot" loading="lazy" class="img-fluid w-50 mt-3">
            </div>
        </div>
</div>
