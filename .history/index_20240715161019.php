...
.star {
    animation: blink 4s step-start infinite; /* Augmentez cette valeur pour ralentir l'animation */
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            for (let i = 0; i < 30; i++) {
                ...
                for (let j = 0; j < binaryLength; j++) {
                    ...
                    span.className = 'star';
                    span.style.animationDelay = `${Math.random() * 12}s`; // Délai d'animation aléatoire
