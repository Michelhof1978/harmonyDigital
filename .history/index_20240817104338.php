...
<div class="d-md-none">
    ...
    <div class="text-center mb-3">
        ...
        <p class="text-white lead fs-2 ms-2 me-2 fw-bold mb-3 mt-2">
            La Satisfaction Client en Priorité
        </p>
    </div>

    <div class="container d-flex justify-content-center align-items-center" style="min-height: calc(100vh - 6rem); padding: 0;">
