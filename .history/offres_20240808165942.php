...
<body>
    ...
    <div class="row ">
      ...
      <div class="col-sm-12 col-xl-6 ">
        <img src="images/" alt="Le Pal" loading="lazy" class="img-fluid rounded-2">
      </div>

      <div class="col-sm-12 col-xl-6 ">
        <p class=" lead bg-light rounded shadow p-4 pb-5 bg-white rounded ms-1 me-1 ">
        L’expert métier, c’est vous ! L’expert tech and agile, c’est nous ! 
        Ensemble, nous donnerons vie à vos projets, du concept à l’hébergement dans le cloud et au-delà. 
