...
<script>
 // Fonction pour vérifier si le popup a déjà été affiché aujourd'hui
  ...
  if (!isPopupShown()) {
    ...
    popupDiv.style.cssText = "position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 9999; text-align: center; padding: 20px; border: 1px solid #ccc; border-radius: 8px;";

    let img = document.createElement("img");
    img.src = "images/offre2024.png"; 
    img.style.height = window.innerWidth < 600 ? '60%' : '40%';
