...
<div class="ms-3">
    ...
    <p class="text-white">React et Vue.js</p>                                 <img src="images/card2.png" alt="site internet" loading="lazy" onmouseover="zoomIn(this)" onmouseout="zoomOut(this)" class="imgcard img-fluid">
