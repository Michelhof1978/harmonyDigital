...
<div class="d-flex justify-content-center align-items-center d-md-none" style="min-height: 50vh; margin: -20px">
...
<div class="d-flex justify-content-center align-items-center d-none d-md-flex" style="min-height: 50vh; margin-top: -100px; margin-bottom: -30px">
