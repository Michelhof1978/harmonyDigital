...
<div class="d-flex justify-content-center align-items-center d-md-none" style="min-height: 50vh;">
...
<div class="d-flex justify-content-center align-items-center d-none d-md-flex" style="min-height: 50vh;">
    <div class="video-container col-12 col-lg-6 d-flex justify-content-center">
        <video autoplay loop muted playsinline class="rounded" style="max-width: 800px; width: 100%;">
            <source src="videos/videotarif.mp4" type="video/mp4">
            Votre navigateur ne supporte pas la balise <code>video</code>.
        </video>
    </div>
