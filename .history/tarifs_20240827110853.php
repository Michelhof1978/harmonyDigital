...
<meta property="og:url" content="https://harmony-digital.fr/tarifs">
    ...
    <style>
 .video-container {
    /* Assurez-vous que la vidéo est correctement contenue */
    flex-shrink: 0; /* Empêche la vidéo de se rétrécir */
}

.robotIndex {
    /* Position relative pour que l'image soit à côté de la vidéo */
    width: auto; /* La largeur s'ajuste automatiquement selon le contenu */
    margin-left: 15px; /* Espacement à gauche pour l'image */
}
...
<div class="mt-5 mb-5 d-flex align-items-center">
    ...
    <div class="robotIndex d-none d-md-block ms-3">
