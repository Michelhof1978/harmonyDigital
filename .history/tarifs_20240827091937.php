    ...
    <div class="row align-items-center mt-4">
        <div class="col-md-6">
            <div class="tarif-details">
                ...
                <p><strong>Tarif Abonnement:</strong> <span class="discord fw-bold">De 50 à 200 euros</span> mensuel</p>
                <ul>
                ...
                <p><strong>Tarif Annuel:</strong> <span class="discord fw-bold">De 15 à 70 euros par an</span></p>
                <ul>
                    <li>Enregistrement et renouvellement du nom de domaine</li>
                </ul>

                <h3>Hébergement</h3>
                <p><strong>Tarif Annuel:</strong> <span class="discord fw-bold">De 60 à 200 euros</span> par an</p>
                <ul>
...
<div class="fw-bold text-center m-5 text-white press-start-2p-regular">
    Pour toute demande relative aux tarifs de nos autres service,<br> nous vous prions de bien vouloir nous contacter.
</div>
