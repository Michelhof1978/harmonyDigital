...
.borderColor {
 ...
 #star-container {
  position: relative;
  z-index: 1; /* Cette propriété permet de placer la section au-dessus de l'animation de fond */
}
#star-container {
  position: absolute;
  top: 0;
  ...
  height: 100%;
  color: #7ed2f1c4;
  z-index: 0; /* Cette propriété permet de placer la div en arrière-plan */
}
