...
<img src="images/gif5.gif" alt="robot gif" class="img-fluid d-none d-md-block" style="margin-bottom: -43px; margin-left: 150px;">
 <!--Fin Banner desktop -->
    ...
    <div class="text-center mt-5">
        ...
        <h3 class="border borderColor border-4 rounded p-2 mx-auto">
            <strong class="text-white"> Paiement possible en plusieurs fois ou sous forme d'abonnement pour les sites web</strong>
        </h3>
    </div>
