...
<div class="text-center">
    ...
    <p class="text-white lead fs-2 ms-2 me-2 fw-bold mb-5">
...
<!-- ROBOT VIDEO-->
<div class="text-center">
    <h2 class="border borderColor border-4 rounded p-2 m-3 mb-3"> <!-- Marges réduites -->
        <strong class="text-white">Robots Dévoués</strong>
    </h2>
    <p class="text-white lead fs-2 ms-2 me-2 fw-bold mb-3"> <!-- Marges réduites -->
        La Satisfaction Client en Priorité
    </p>
</div>
...
<div class="container d-flex justify-content-center align-items-center min-vh-100 mt-5">
    ...
    <div class="d-md-none w-100" style="margin: 0 0 20px 0; padding-top: 10px;"> <!-- Marges et padding ajustés -->
        <video autoplay loop muted playsinline class="w-100 rounded">
            <source src="videos/robotordi.mp4" type="video/mp4">
            Votre navigateur ne supporte pas la balise <code>video</code>.
        </video>
