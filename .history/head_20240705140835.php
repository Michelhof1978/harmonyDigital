...
@media (max-width: 768px) {
    ...
    .navbar-brand {
        margin-bottom: 1rem;
        text-align: center;
        order: 1; /* Assurez-vous que le logo et le titre viennent en premier */
    }
    ...
    .navbar-toggler {
        ...
        order: 2; /* Assurez-vous que le bouton hamburger vient après le logo et le titre */
    }

    .navbar-collapse {
        order: 3; /* Assurez-vous que le menu collapsé vient après le bouton hamburger */
    }
