...
@media (max-width: 768px) {
    .card {
        transform: none;
        width: 90%; /* Occupe la majorité de la largeur disponible sur mobile */
...
<!-- FIN INTRO-->
    ...
    <div id="tarifCarousel" class="carousel slide carousel-container" data-bs-ride="carousel">
        <div class="carousel-inner">
            <!-- Premier groupe de cartes pour desktop -->
            ...
            <!-- Premier groupe de cartes pour mobile -->
            ...
            <!-- Deuxième groupe de cartes pour desktop -->
            ...
            <!-- Deuxième groupe de cartes pour mobile -->
            <div class="carousel-item d-block d-md-none">
                <div class="card mx-auto">
                    <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                        <img src="images/card4.png" alt="site internet" loading="lazy" onmouseover="zoomIn(this)" onmouseout="zoomOut(this)" class="imgcard img-fluid">
