...
/* CARDS DESKTOP */
.card-small {
    transform: scale(0.6);  /* Réduit la taille à 60% de l'original */
    transform-origin: center center;
...
.carousel-inner .carousel-item {
    ...
    justify-content: center;
    align-items: center;
    height: 400px;  /* Ajustez cette valeur pour contrôler la hauteur du carrousel */
}

/* Ajustez la taille du texte et des boutons si nécessaire */
.card-small .pricecard {
    ...
    <div id="tarifCarousel" class="carousel slide carousel-container mt-1">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <div class="card mt-2 card-small">
