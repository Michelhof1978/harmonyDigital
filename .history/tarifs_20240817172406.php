...
<div class="container-fluid px-0 mb-5">
    <div class="d-flex justify-content-center align-items-center" style="min-height: 50vh;">
        <div class="video-container d-none d-md-flex justify-content-center align-items-center">
            <video autoplay loop muted playsinline class="rounded" style="width: 50%; max-width: 600px; height: auto;">
