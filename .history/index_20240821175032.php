...
<div class="container-fluid d-flex justify-content-center align-items-center full-height mt-5 d-md-none">
 ...
 <!-- INTRO-->
<div class="mt-5">
    <h1 class="mt -5border borderColor border-4 rounded p-2 col m-4 text-center text-white fw-bold">
        Votre Partenaire pour la Création de Sites Web Professionnels
    </h1>
</div>
...
<div class="mt-5 container mb-5">
    <div class="row align-items-center justify-content-center text-center">
        <div class="col-12 col-md-6 mt-3 order-2 order-md-1">
            ...
            <img src="images/offre2024.webp" alt="robot" loading="lazy" class="img-fluid w-50 w-md-75 mx-auto">
        </div>
