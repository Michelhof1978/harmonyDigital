...
.neon-yellow {
    color: #FFFF66; /* Code couleur pour un jaune néon encore plus clair */
    text-shadow: 0 0 10px rgba(255, 255, 102, 0.7), 
                 0 0 20px rgba(255, 255, 102, 0.7), 
                 0 0 30px rgba(255, 255, 102, 0.7);
    box-shadow: 0 0 20px rgba(255, 255, 102, 0.7), 
                0 0 30px rgba(255, 255, 102, 0.5), 
                0 0 40px rgba(255, 255, 102, 0.4);
