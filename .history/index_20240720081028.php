    ...
    <div class="offre row ">
      ...
      <div class="col-sm-12 col-xl-6 ">
        <p class="lead bg-light rounded p-4 pb-5 ms-1 me-1 ">
          Profitez d'une expérience de camping unique au Camping proche du Pal de Dompierre Sur Besbre</a>, situé à proximité du parc d'attractions <a href="<?php echo PAL_URL; ?>" target="_blank">Le-Pal</a></strong>.
