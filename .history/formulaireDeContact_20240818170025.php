...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errors)) {
        ...
        $retour = mail("michelhoff1978@gmail.com", $objet, $messageContent, "From: contact@harmony-digital.fr" . "\r\n" . "Reply-to: $email");
...
<div id="binary-background2"></div>
  ...
  <!-- Banner mobile -->
    ...
    <img src="images/banniererobotform.png" alt="Bannière de bienvenue avec un robot" class="img-fluid w-50 rounded">
</div>
  <!--Fin Banner mobile -->
