...
<!-- ROBOT VIDEO DESKTOP -->
<div class="container-fluid px-0 mb-5 d-none d-md-block" style="margin-left: 25 px">
    <div class="row justify-content-center align-items-center g-5" style="min-height: 50vh;">
        ...
        <div class="col-md-6 d-flex justify-content-center">
            <a href="https://lescaravanesdelabesbre.fr/" target="_blank" rel="noopener noreferrer">
                <img src="images/caravanesdelabesbre.webp" alt="Description de l'image" class="img-fluid">
            </a>
        </div>
    </div>
</div>
