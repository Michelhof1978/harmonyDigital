...
<?php else: ?>
    ...
    <section class="confirmation mb-5">
        <h4 class=" borderColorm-5 text-center border border-3 rounded text-white p-2 display-6 h4Index" id="contact"><strong>AUCUN MESSAGE DE CONFIRMATION</strong></h4>
        <div class="text-center">
