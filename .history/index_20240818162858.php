...
<div class="text-center ms-2 me-2 d-block d-md-none" style="margin-top:-50px;"> <!-- Affiche uniquement sur mobile -->
    <div>
...
<div class="text-center ms-2 me-2 d-none d-md-block" style="margin-top:-50px;"> <!-- Affiche uniquement sur desktop -->
    <div>
        <h2 class="border borderColor border-4 rounded p-2 mb-4">
            <strong class="text-white">Nos Prestations</strong>
        </h2>
