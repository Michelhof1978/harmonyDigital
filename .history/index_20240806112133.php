...
<div class="d-flex justify-content-center align-items-center vh-75" style="background-image: url('Images/fondBleu.png');">
        <div class="text-center">
            <p class="fs-5 text-white  p-3 rounded ms-4 me-4">
                <strong>
