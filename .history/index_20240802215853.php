        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <div class="row">
                    ...
                    <div class="col-6 col-md-4 mb-4 d-none d-md-block">
                        <div class="card h-100">
            ...
            <div class="carousel-item">
                <div class="row">
                    <div class="col-6 col-md-4 mb-4">
                        <div class="card h-100">
                            <!-- Contenu de la carte 4 -->
                        </div>
                    </div>
                    <div class="col-6 col-md-4 mb-4">
                        <div class="card h-100">
                            <!-- Contenu de la carte 5 -->
                        </div>
                    </div>
                    <div class="col-6 col-md-4 mb-4 d-none d-md-block">
                        <div class="card h-100">
                            <!-- Contenu de la carte 6 -->
                        </div>
                    </div>
                </div>
            </div>

            <!-- Troisième groupe (visible uniquement sur mobile) -->
            <div class="carousel-item d-md-none">
                <div class="row">
                    <div class="col-6 mb-4">
                        <div class="card h-100">
                            <!-- Contenu de la carte 3 (répété pour mobile) -->
                        </div>
                    </div>
                    <div class="col-6 mb-4">
                        <div class="card h-100">
                            <!-- Contenu de la carte 6 (répété pour mobile) -->
                        </div>
                    </div>
                </div>
            </div>
