...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">  
    <div class="container-fluid">
        ...
        <!-- Bouton hamburger -->
        <button class="navbar-toggler mx-auto w-50" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
