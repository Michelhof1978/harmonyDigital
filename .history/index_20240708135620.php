  ...
  <strong>Nos Tarifs</strong>
    ...
    <div class="row ">
      <div class="col-lg-3 col-md-6">
        <div class="card">
          <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
            ...
            <strong class="text-success custom-animation">A partir de 600,00 €</strong>
            <p class="card-text">
                -Site vitrine<br>
                -Corporate<br>
                -Evènementiel<br>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card">
          <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
            <img src="images/card" alt="Hébergements le pal" loading="lazy" class="img-fluid rounded-3 mt-4">
          </div>
          <div class="card-body">
