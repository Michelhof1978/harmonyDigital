...
?>
  ...
  <div class="container-fluid">
    ...
    <div class="d-flex flex-column align-items-center navbar-brand">
      <a class=" fs-2 mb-3 mt-2" href="index.php">
    ...
    <!-- Bouton hamburger centré en dessous de Harmony Digital -->
