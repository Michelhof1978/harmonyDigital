...
<!-- ROBOT VIDEO MOBILE -->
<div class="d-md-none" style="margin: 0; padding: 0; height: 100vh; overflow: hidden;">
    ...
    <div class="text-center" style="margin: 0; padding: 0;">
        ...
        <p class="text-white lead fs-2 ms-2 me-2 fw-bold mb-0 mt-1">
            La Satisfaction Client en Priorité
        </p>
    </div>

    <div class="container d-flex justify-content-center align-items-center" style="height: calc(100vh - 4rem); padding: 0; margin: 0;">
