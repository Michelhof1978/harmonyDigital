...
<!-- FIN PRESENTATION LOGOS-->
    ...
    <script>
        function updateCountdown() {
            const targetDate = new Date("2024-01-31T00:00:00").getTime();
            ...
            document.getElementById("countdown").innerHTML = `T-${days}:${String(hours).padStart(2, '0')}:${String(minutes).padStart(2, '0')}:${String(seconds).padStart(2, '0')}`;
