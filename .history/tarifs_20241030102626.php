    ...
    <div class="row align-items-center mt-4">
        <div class="col-md-6">
            <div class="tarif-details">
                ...
                <h3 class="discord">Maintenance et Support</h3>
                ...
                <h3 class="discord">Nom de Domaine</h3>
                ...
                <h3 class="discord">Protection contre les intrusions et les attaques par piratage</h3>
