    ...
    <div class="container mt-4 mb-5">
        <div class="row">
            <div class="col-8">
                ...
                Notre Product Owner fera le lien entre toutes les parties investies dans le projet, dès le premier jour et jusqu'à. <br>Il sera votre référent tout au long de notre collaboration.
                </p>
            </div>
            <div class="col-4">
