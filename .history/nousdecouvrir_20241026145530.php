...
<div class="d-none d-md-block">
    ...
    <p class="lead text-white text-center fs-5 mt-5 mb-5 fw-bold">
        Du concept à sa réalisation et au-delà, <span class="span fw-bold">Harmony Digital</span> s’appuie sur son approche 
    ...
    <span class="span fw-bold">Laissez-nous vous simplifier la vie !</span>
</p>
