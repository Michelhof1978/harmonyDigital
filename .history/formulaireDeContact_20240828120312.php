...
<div id="binary-background2"></div>
  ...
  <!-- Banner mobile -->
    ...
    <img src="images/banniererobotform.webp" alt="Bannière illustrative de bienvenue avec un robot" class="img-fluid w-50 rounded">
</div>
  <!--Fin Banner mobile -->
...
<div class="container-fluid d-flex justify-content-center align-items-center full-height mt-5 d-md-none">
 ...
 <img src="images/gif7.gif" alt="robot gif" class="img-fluid d-block d-md-none" style="margin-bottom: -35px;">

<img src="images/gif7.gif" alt="robot gif" class="img-fluid d-none d-md-block" style="margin-bottom: -43px; margin-left: 150px;">
