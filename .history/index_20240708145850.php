      ...
      <div class="col-lg-3 col-md-6">
        <div class="card bg-dark">
          <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
            ...
            <strong><span class="text-orange-nav">S</span>ites &nbsp <span class="text-orange-nav">V</span>itrines</strong><br>
            <strong><span class="text-orange-nav">C</span>orporate &nbsp <span class="text-orange-nav">V</span>itrines</strong><br>
