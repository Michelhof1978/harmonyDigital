...
<body>
    ...
    <div class="container tarifs-section">
        <h1 class="text-center">Tarifs pour la Création de Site Web par Freelance</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="tarif-details">
                    ...
                    <p><strong>Tarif :</strong> De 500 à 2 000 euros</p>
                    <ul>
                        ...
                        <li>Formation pour la gestion du contenu (optionnelle)</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="tarif-details">
                    ...
                    <p><strong>Tarif :</strong> De 2 000 à 5 000 euros</p>
                    <ul>
