  ...
  <div class="text-center">
    ...
    <div class="row g-0 flex-column flex-md-row">
        ...
        <div class="col text-center align-self-center">
            ...
            <a href="<?php echo PENICHE_URL; ?>"><img src="../images/lePal.webp" alt="Logo le pal" loading="lazy" class="logoPal img-fluid "></a>
        </div>
        ...
        <div class="col d-none d-md-block">
            <div class="videoPal embed-responsive embed-responsive-16by9">
                ...
                <div class="video-description">VInvitation Anniversaire</div>
            </div>
        </div>
