...
.neon-section {
    background-color: #333; /* Couleur de fond pour faire ressortir l'ombre */
    border-radius: 15px; /* Arrondir les bords de la section */
    box-shadow: 0 0 10px rgba(255, 255, 51, 0.5), 
                0 0 20px rgba(255, 255, 51, 0.3), 
                0 0 30px rgba(255, 255, 51, 0.2);
    padding: 20px; /* Ajouter du padding pour que le contenu ne touche pas les bords arrondis */
    margin: 20px; /* Ajouter une marge pour que l'ombre soit visible */
}
