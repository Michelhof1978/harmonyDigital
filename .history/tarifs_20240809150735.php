...
<body>
        ...
        <div class="row ">
            ...
            <div class="col-md-6">
                <div class="tarif-details">
                    ...
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 590 à 2 000 euros</p>
                    <ul>
            ...
            <div class="col-md-6">
                <div class="tarif-details">
                    ...
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 2 200 à 5 000 euros</p>
                    <ul>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="tarif-details">
                    ...
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 4 000 à 8 500 euros</p>
                    <ul>
            ...
            <div class="col-md-6">
                <div class="tarif-details">
                    ...
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 7 000 à 18 000 euros</p>
                    <ul>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="tarif-details">
                    ...
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 50 à 200 euros par mois</p>
                    <ul>
                    ...
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 10 à 30 euros par an</p>
                    <ul>
                        <li>Enregistrement et renouvellement du nom de domaine</li>
                    </ul>

                    <h3>Hébergement</h3>
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 50 à 200 euros par an</p>
                    <ul>
    ...
    <h1 class="border borderColor border-4 rounded p-2 col m-4 text-center">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="tarif-details">
                    ...
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 300 à 800 euros</p>
                    <ul>
            ...
            <div class="col-md-6">
                <div class="tarif-details">
                    ...
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 800 à 1 500 euros</p>
                    <ul>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="tarif-details">
                    ...
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 3 000 à 6 000 euros ou plus</p>
                    <ul>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="tarif-details">
                    ...
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 100 à 300 euros par déclinaison</p>
                    <ul>
                        <li>Versions du logo pour des usages spécifiques (réseaux sociaux, applications, etc.)</li>
                    </ul>
                    
                    <h3>Création de Visuels Associés</h3>
                    <p><strong>Tarif :</strong><span class="discord fw-bold"> De 150 à 500 euros</p>
                    <ul>
        ...
        <div class="discord fw-bold text-center">Pour toute demande relative aux tarifs, nous vous prions de bien vouloir nous contacter.</div>
    </section>
