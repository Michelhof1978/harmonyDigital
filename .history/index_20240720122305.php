...
.robotDomaine2 {
    max-width: 80%; /* Ajustez la valeur pour agrandir l'image */
    height: auto; /* Conserve le ratio de l'image */
    position: absolute; /* Positionnement absolu */
    left: 0; /* Aligne l'image à gauche de l'écran */
    top: 20px; /* Décale l'image vers le bas depuis le haut de l'écran */
    /* Assurez-vous que le conteneur parent a la position relative */
}
.h2competence {
  margin-top: -70px;
}
