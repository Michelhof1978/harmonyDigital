...
<section class="container tarifs-section text-white">
    ...
    <img src="images/imagetarifs.webp" alt="présentation d'un forfait mensuel pour création site web" class="img-fluid m-3 w-50 d-flex justify-content-center align-items-center">
