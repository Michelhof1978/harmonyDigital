...
.card {
  ...
  margin: 0 15px; /* Ajoute une marge égale de chaque côté pour séparer les cartes */
}
...
.carousel-control-prev {
  left: 10px; /* Déplacez-le légèrement vers l'intérieur */
}

/* Positionnez le bouton "Suivant" à droite */
.carousel-control-next {
  right: 10px; /* Déplacez-le légèrement vers l'intérieur */
}
