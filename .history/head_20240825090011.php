...
<!-- css Titres ne fonctionne pas ds le fichier css-->
  <style>
/* H1 Pour les écrans de 768px ou moins (tablettes et smartphones) */
@media (max-width: 768px) {
    h1 {
        font-size: 2em; /* Ajustez cette taille pour les mobiles */
    }
}

/* H1 Pour les écrans de 480px ou moins (smartphones) */
@media (max-width: 480px) {
    h1 {
        font-size: 1.8em; /* Taille encore plus petite pour les petits écrans */
    }
}
 /* COOKIES */
#cookie-banner {
