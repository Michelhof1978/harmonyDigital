...
<section class="container tarifs-section text-white">
    ...
    <div class="row">
        ...
        <li>Intégration de plugins, <a href="https://www.cnil.fr/fr/definition/interface-de-programmation-dapplication-api" target="_blank" class="link-white">API</a> ou modules supplémentaires</li>
