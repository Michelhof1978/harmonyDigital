...
<div class="mt-5 container mb-5">
    <div class="row align-items-center justify-content-center text-center">
        <div class="col-12 col-md-6 mt-3 order-2 order-md-1">
            ...
            <img src="images/offre2024.webp" alt="promotion de -10% pour les 50 prochains clients, offre vala jusqu'à la fin de l'année" loading="lazy" class="img-fluid w-50 w-md-75 mx-auto">
        </div>
