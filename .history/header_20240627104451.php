...
?>
  ...
  <div class="container-fluid">
    ...
    <!-- Bouton hamburger et texte Menu -->
    <button class="navbar-toggler w-50 h-50" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <img src="images/hamburger.png" loading="lazy" alt="Hamburger navbar" class="me-2 mt-1" style="height: 30px;">
      <span class="align-middle mt-1">Menu</span>
    </button>

    <!-- Menu collapsé pour les appareils mobiles -->
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto" id="menu"> <!-- Alignement à droite -->
        <li class="nav-item">
