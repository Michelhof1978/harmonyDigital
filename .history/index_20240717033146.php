...
<body>
    ...
    <div>
            <h1 class="border borderColor border- rounded  p-2 col m-2">
                <strong class="text-white"><span class="text-orange-titre">C</span>concepteur<span class="text-orange-titre"> T</span>arifs</strong>
            </h1>
        </div>
    <!-- TARIFS -->
    <section  class="text-center mt-4 ms-2 me-2">
        <div>
            <h4 class="border borderColor border-4 rounded  p-2 col m-2">
