...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($email === null) {
        ...
        if (!$recaptchaResult['success']) {
            ...
            $retour = mail("harmonydigitalweb@gmail.com", $objet, $message, "From: contact@harmony-digital.fr" . "\r\n" . "Reply-to: $email");
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-6">
                ...
                <div class="row mb-4">
                    ...
                    <!-- reCAPTCHA -->
                    <div class="g-recaptcha mt-4 m" data-sitekey="6LeDJiQqAAAAALRhC54Yqk-PnttYsWFvK9Ev6Zew"></div>
