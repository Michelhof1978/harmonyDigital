...
<img src="images/bannercards.webp" alt="Robot de décoration" loading="lazy" class="img-fluid mt-3 mb-3 w-100">
...
<div class="text-center ms-2 me-2 d-none d-md-block" > <!-- Affiche uniquement sur desktop -->
    <div>
        ...
        <img src="images/bannercards.webp" alt="Robot de décoration" loading="lazy" class="img-fluid w-75 m-5">
...
<div class="d-block d-md-none d-flex ms-0 mb-5 position-relative ms-2 me-5">
    ...
    <div class="w-75 neon-section text-center">
        ...
        <div class="m-3">
            ...
            <img src="images/robotSeparateur6." alt="Robot de décoration séparateur de texte" loading="lazy" class="img-fluid robotSeparateur mb-3"> 
