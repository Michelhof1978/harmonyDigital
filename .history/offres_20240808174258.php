...
<body>
    ...
    <section class="container mt-4">
       <div class="row">
            ...
            <div class="col-8">
                <p class="lead text-white text-center fw-bold fs-5 mt-5">
                    Vous avez déjà démarré la digitalisation de vos process mais vous souhaitez être conseillés et accompagnés ?
                     Nous vous proposons notre expertise et notre approche SMART pour faire de votre projet un succès ! Audit technique, accompagnement personnalisé et coaching,…
                </p>
            </div>
            <div class="col-4">
